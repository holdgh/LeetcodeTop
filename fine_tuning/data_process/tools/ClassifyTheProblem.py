    ...
    },
{
        ...
        "keywords": [
            ...
            "为什么发生污染", "为什么铺粉不完全", "为什么球化","是如何产生的","发生的诱因","异常产生的根源是",
            "为什么翘曲凸起", "导致异常", "形成原因", "技术问题","哪些因素触发",
            "工艺条件", "设备问题", "软件问题", "参数问题","可能因素", "可能性来源", "引发因素", "引起原因",
            "导致原因", "为何出现", "因素引起", "什么引起","产生机制",
            "球化原因", "翘曲原因", "铺粉不完整原因"
        ],
        "regex": [
...
r"(导致|引起|引发).*异常.*(因素|原因)",
    ...
    },
    {
        "name": "特定异常确认",
        "keywords": [
            "是否发生污染", "是否发生刮痕", "是否发生球化", "是否铺粉不完全","是否存在刮刀横/竖条纹",
...
def main():
    if os.path.exists("/nas_data/taoss/Multi_model_label/new/withoutImage.json"):
    ...
    output_file = "/nas_data/taoss/Multi_model_label/new/withoutImage_category.json"
