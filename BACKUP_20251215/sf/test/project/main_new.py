...
base_url="http://192.168.0.213:6661/v1"
...
async def analyze(question: str = Form(...),
    ...
    if image is None:
        ...
        output_path = f"/nas_data/lyl_project/sf/static/output_{output_filename}"
        # output_path = "/nas_data/lyl_project/sf/static/output.jpg"
        # output_path = f"/nas_data/lyl_project/sf/static/output_{uuid.uuid4()}.jpg"
        ...
        if intent == "model":
            ...
            yolo_output_image_url = f"/static/output_{output_filename}"
